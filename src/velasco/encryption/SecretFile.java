...
public class SecretFile {
    ...
    public SecretFile(File file, String password, int mode) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeySpecException, InvalidAlgorithmParameterException, InvalidKeyException, IOException {
        this.file = file;
...
//        Prepare our message digest object
    ...
    private void loadFromFile() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException, InvalidAlgorithmParameterException, InvalidKeyException {
        BufferedInputStream inputStream = new BufferedInputStream(new FileInputStream(file));
...
//        final String inputFile = "/Users/avelasco/Desktop/Input.txt";
//        final String encryptedFile = "/Users/avelasco/Desktop/Input.txt.aes";
//        final String decryptedFile = "/Users/avelasco/Desktop/Input-decrypt.txt";
        final String inputFile = "/Users/avelasco/Desktop/Skip-Bo-Game-Layout.svg";
        final String encryptedFile = "/Users/avelasco/Desktop/Skip-Bo-Game-Layout.svg.aes";
        final String decryptedFile = "/Users/avelasco/Desktop/Skip-Bo-Game-Layout-decrypt.svg";
        ...
        for(char c = 0; c < 256; c++){
            SecretFile fileToCrack = new SecretFile(new File(encryptedFile), "Secure Passwor" + c, Cipher.DECRYPT_MODE);
            if(fileToCrack.verifyPassword()){
                System.out.printf("Success %c\n", c);
            } else {
                System.out.printf("Failed %c\n", c);
            }
